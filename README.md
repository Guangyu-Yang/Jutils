...
```
The command above creates Venn diagram representations of gene sets from multiple TSV files, corresponding to multiple tools or comparisons. The format of the TSV file list is here.
...
Examples of scripts for all of the above scenarios are provided below:
